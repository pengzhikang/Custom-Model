...
struct time FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_SEC, 1) &&
           verifier.EndTable();
  }
};
...
struct TensorShape FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_DIMSIZE, 1) &&
...
struct Weights FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_ELE_BYTES, 1) &&
           VerifyField<uint64_t>(verifier, VT_ELE_NUM, 8) &&
...
struct Tensor FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int8_t>(verifier, VT_TESOR_TYPE, 1) &&
           VerifyField<int8_t>(verifier, VT_DATA_TYPE, 1) &&
           VerifyField<int8_t>(verifier, VT_DATA_LAYOUT, 1) &&
...
struct AttrMeta FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int8_t>(verifier, VT_BUFFER_DATA, 1) &&
           VerifyField<uint32_t>(verifier, VT_BUFFER_ELE_NUM, 4) &&
           VerifyOffset(verifier, VT_BUFFER) &&
           verifier.VerifyVector(buffer()) &&
           verifier.EndTable();
  }
...
struct Attributes FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint32_t>(verifier, VT_META_NUM, 4) &&
           VerifyField<uint32_t>(verifier, VT_META_REQUIRE_NUM, 4) &&
           VerifyOffset(verifier, VT_BUFFER) &&
           verifier.VerifyVector(buffer()) &&
...
struct Connect FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_NAME) &&
           verifier.VerifyString(name()) &&
           VerifyField<uint8_t>(verifier, VT_NECESSARY, 1) &&
...
struct Layer FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_TYPE) &&
           verifier.VerifyString(type()) &&
           VerifyField<uint8_t>(verifier, VT_INPUT_NUM, 1) &&
           VerifyField<uint8_t>(verifier, VT_OUTPUT_NUM, 1) &&
           ...
           VerifyField<uint8_t>(verifier, VT_REQUIRE_ATTRS, 1) &&
...
struct PModel FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint32_t>(verifier, VT_MODEL_RUNTIME_INPUT_NUM, 4) &&
           VerifyField<uint32_t>(verifier, VT_MODEL_RUNTIME_OUTPUT_NUM, 4) &&
...
inline bool SizePrefixedPModelBufferHasIdentifier(const void *buf) {
  return flatbuffers::BufferHasIdentifier(
      buf, PModelIdentifier(), true);
}
